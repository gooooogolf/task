...
<div class="container">
	...
	<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/stock/organization-save">
	...
	<div class="form-group">
	<label class="col-sm-2" for="provinceName"> </label>
		<div class="col-sm-10"> 
			<button type="submit" class="btn btn-primary">บันทึกข้อมูล</button>
			<button type="button" class="btn btn-default" onclick="javascript:window.location.href='${pageContext.request.contextPath}/stocks/organization-for-update?orgId=${organization.orgId }&stockYear=${stockYear }'">ย้อนกลับ</button>
		</div>
	</div>	
