...
<div class="container">
	...
	<form class="form-horizontal"  role="search" action="${pageContext.request.contextPath}/stocks/organization-for-update?orgId=${organization.orgId }" method="post">
...
<%-- 	</c:if> --%>
	<form action="${pageContext.request.contextPath}/stocks/organization-new?orgId=${organization.orgId }" method="post">
		<input name ="ids" id="ids" type="hidden" value="">
		<button type="submit" class="btn btn-danger">ตัด Stock ให้${organization.orgName }</button>
		<button type="button" class="btn btn-default" onclick="javascript:window.location.href='${pageContext.request.contextPath}/stock/organization?orgId=${organization.orgId }'">ย้อนกลับ</button>
		<br><br>
	</form>	
</div>
